...
public class IntegrationVariant {
    ...
    public static List<IntegrationVariant> testVariants() {
        ...
        return Arrays.asList(
            ...
            new IntegrationVariant(new ParseTableVariant(ActionsForCharacterRepresentation.Separated,      ProductionToGotoRepresentation.ForLoop),     new JSGLR2Variants.ParserVariant(ActiveStacksRepresentation.LinkedHashMap, ForActorStacksRepresentation.LinkedHashMap, ParseForestRepresentation.Hybrid, ParseForestConstruction.Full, StackRepresentation.HybridElkhound, Reducing.Elkhound), ImploderVariant.Recursive,            TokenizerVariant.TreeShaped),/*
